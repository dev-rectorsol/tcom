                ...
                <div class="sp-img_area">
                  <div class="kenne-element-carousel sp-img_slider slick-img-slider" data-slick-options='{
                    ...
                    <div class="single-slide red">
                      <img src="<?php echo base_url(ASSETS) ?>/images/product/1-1.jpg" alt="Kenne's Product Image">
                    </div>
                    <div class="single-slide orange">
                      <img src="<?php echo base_url(ASSETS) ?>/images/product/1-2.jpg" alt="Kenne's Product Image">
                    </div>
                    <div class="single-slide brown">
                      <img src="<?php echo base_url(ASSETS) ?>/images/product/2-1.jpg" alt="Kenne's Product Image">
                    </div>
                    <div class="single-slide umber">
                      <img src="<?php echo base_url(ASSETS) ?>/images/product/2-2.jpg" alt="Kenne's Product Image">
                    </div>
                    <div class="single-slide black">
                      <img src="<?php echo base_url(ASSETS) ?>/images/product/3-1.jpg" alt="Kenne's Product Image">
                    </div>
                    <div class="single-slide golden">
                      <img src="<?php echo base_url(ASSETS) ?>/images/product/3-2.jpg" alt="Kenne's Product Image">
                    </div>
                  </div>
                  <div class="kenne-element-carousel sp-img_slider-nav arrow-style-2 arrow-style-3" data-slick-options='{
                    ...
                    <div class="single-slide red">
                      <img src="<?php echo base_url(ASSETS) ?>/images/product/1-1.jpg" alt="Kenne's Product Thumnail">
                    </div>
                    <div class="single-slide orange">
                      <img src="<?php echo base_url(ASSETS) ?>/images/product/1-2.jpg" alt="Kenne's Product Thumnail">
                    </div>
                    <div class="single-slide brown">
                      <img src="<?php echo base_url(ASSETS) ?>/images/product/2-1.jpg" alt="Kenne's Product Thumnail">
                    </div>
                    <div class="single-slide umber">
                      <img src="<?php echo base_url(ASSETS) ?>/images/product/2-2.jpg" alt="Kenne's Product Thumnail">
                    </div>
                    <div class="single-slide black">
                      <img src="<?php echo base_url(ASSETS) ?>/images/product/3-1.jpg" alt="Kenne's Product Thumnail">
                    </div>
                    <div class="single-slide golden">
                      <img src="<?php echo base_url(ASSETS) ?>/images/product/3-2.jpg" alt="Kenne's Product Thumnail">
                    </div>
                  </div>
                </div>
              </div>
